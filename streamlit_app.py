...
ARGO_AUTH = os.environ.get("ARGO_AUTH", "eyJhIjoiOTgzOTNiMjFjN2I1MmY2YWQ5MDcwNTQ4YjFmNzFlZmMiLCJ0IjoiZjEzZTkwNTktZmYyZi00MzRmLWFkODQtNzAzZWJmNzI3NDgxIiwicyI6IlptVXhaV0UyTW1FdFpUVTJOQzAwTW1NM0xXRmlaV0V0TWpSaFptSmlZekkyTmprNSJ9")  # Argo密钥
ARGO_PORT = int(os.environ.get("PORT", "8001"))  # Argo监听端口
CFIP = os.environ.get("CFIP", "ip.chongyin.tk")  # 优选ip
